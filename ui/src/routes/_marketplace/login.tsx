      ...
      <div className="w-full max-w-[672px]">
        ...
        <div className="mb-4">
          {!accountId ? (
            <button
              ...
              disabled={isLoading}
              className="w-full bg-[#00ec97] border-2 border-border px-6 py-5 flex items-center justify-center gap-3 hover:bg-[#00d687] transition-colors disabled:opacity-50"
            >
            ...
            <div className="space-y-3">
              ...
              <button
                ...
                disabled={isLoading}
                className="w-full bg-background border-2 border-border px-6 py-3 flex items-center justify-center gap-3 hover:bg-muted transition-colors disabled:opacity-50"
              >
        ...
        <div className="mb-4 space-y-3">
          <button
            ...
            disabled={isLoading}
            className="w-full bg-background border-2 border-border px-6 py-5 flex items-center justify-center gap-3 hover:bg-muted transition-colors disabled:opacity-50"
          >
