    ...
    <div className="space-y-8">
      ...
      <div className="flex flex-row gap-4">
        ...
        <div className="flex-1 rounded-2xl bg-background/60 backdrop-blur-sm border border-border/60 px-4 md:px-8 lg:px-10 py-4 md:py-8">
          <h1 className="text-2xl md:text-3xl font-bold tracking-tight mb-2">Refunds &amp; Returns</h1>
      ...
      <section className="mb-8">
        ...
        . For our complete terms, see our{" "}
          <Link to="/terms-of-service" className="text-[#00EC97] hover:underline transition-colors">
          Terms of Service
        </Link>
        .
      </p>
